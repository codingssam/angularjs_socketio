...
function $RouteProvider() {
   ...
   *
   *    For example, index like `/color/:color/largecode/:largecode*\/edit` will match
   ...
   *
   *    - `[caseInsensitiveMatch=false]` - `{boolean=}` - match index without being case sensitive
   *
   ...
   * @description
   *
   * A boolean property indicating if index defined
